...
#                 torch.load('./results/temp.pth', map_location=device))
...
for epoch in range(epochs):
    ...
    if total_acc+total_acc1 > best_acc :
        best_model_weights = copy.deepcopy(model.state_dict())
        best_acc = total_acc+total_acc1
    ...
    if(epoch%100==0):
        torch.save(best_model_weights, './results/temp1.pth')
